#
# AdjustNLOtherChemicals_A_TOM.jl
#
# Adds specific amounts to emissions from the Breya Renewable Fuels and OtherChemicals
#
# Modified AdjustFactors to reduce spike in Still Gas energy demands in Ref25A. (JSO October 2023)
#
...
function IndPolicy(db)
  ...
  if MacroSwitch[CN] == "TOM"
    ...
    #
    for enduse in Enduses
      CERSM[enduse,ec,NL,Yr(2023)] = CERSM[enduse,ec,NL,Yr(2023)]*0.009
      CERSM[enduse,ec,NL,Yr(2024)] = CERSM[enduse,ec,NL,Yr(2024)]*0.052
      CERSM[enduse,ec,NL,Yr(2025)] = CERSM[enduse,ec,NL,Yr(2025)]*0.060
      CERSM[enduse,ec,NL,Yr(2026)] = CERSM[enduse,ec,NL,Yr(2026)]*0.061
      CERSM[enduse,ec,NL,Yr(2027)] = CERSM[enduse,ec,NL,Yr(2027)]*0.063
      CERSM[enduse,ec,NL,Yr(2028)] = CERSM[enduse,ec,NL,Yr(2028)]*0.064
      CERSM[enduse,ec,NL,Yr(2029)] = CERSM[enduse,ec,NL,Yr(2029)]*0.066
      CERSM[enduse,ec,NL,Yr(2030)] = CERSM[enduse,ec,NL,Yr(2030)]*0.067
      CERSM[enduse,ec,NL,Yr(2031)] = CERSM[enduse,ec,NL,Yr(2031)]*0.068
      CERSM[enduse,ec,NL,Yr(2032)] = CERSM[enduse,ec,NL,Yr(2032)]*0.068
      CERSM[enduse,ec,NL,Yr(2033)] = CERSM[enduse,ec,NL,Yr(2033)]*0.067
      CERSM[enduse,ec,NL,Yr(2034)] = CERSM[enduse,ec,NL,Yr(2034)]*0.065
      CERSM[enduse,ec,NL,Yr(2035)] = CERSM[enduse,ec,NL,Yr(2035)]*0.063
      CERSM[enduse,ec,NL,Yr(2036)] = CERSM[enduse,ec,NL,Yr(2036)]*0.062
      CERSM[enduse,ec,NL,Yr(2037)] = CERSM[enduse,ec,NL,Yr(2037)]*0.063
      CERSM[enduse,ec,NL,Yr(2038)] = CERSM[enduse,ec,NL,Yr(2038)]*0.063
      CERSM[enduse,ec,NL,Yr(2039)] = CERSM[enduse,ec,NL,Yr(2039)]*0.062
      CERSM[enduse,ec,NL,Yr(2040)] = CERSM[enduse,ec,NL,Yr(2040)]*0.062
      CERSM[enduse,ec,NL,Yr(2041)] = CERSM[enduse,ec,NL,Yr(2041)]*0.062
      CERSM[enduse,ec,NL,Yr(2042)] = CERSM[enduse,ec,NL,Yr(2042)]*0.061
      CERSM[enduse,ec,NL,Yr(2043)] = CERSM[enduse,ec,NL,Yr(2043)]*0.061
      CERSM[enduse,ec,NL,Yr(2044)] = CERSM[enduse,ec,NL,Yr(2044)]*0.061
      CERSM[enduse,ec,NL,Yr(2045)] = CERSM[enduse,ec,NL,Yr(2045)]*0.061
      CERSM[enduse,ec,NL,Yr(2046)] = CERSM[enduse,ec,NL,Yr(2046)]*0.061
      CERSM[enduse,ec,NL,Yr(2047)] = CERSM[enduse,ec,NL,Yr(2047)]*0.060
      CERSM[enduse,ec,NL,Yr(2048)] = CERSM[enduse,ec,NL,Yr(2048)]*0.060
      CERSM[enduse,ec,NL,Yr(2049)] = CERSM[enduse,ec,NL,Yr(2049)]*0.059
      CERSM[enduse,ec,NL,Yr(2050)] = CERSM[enduse,ec,NL,Yr(2050)]*0.058
    end
    
    for tech in Techs
      FsPEE[tech,ec,NL,Yr(2023)]=FsPEE[tech,ec,NL,Yr(2023)]*0.0135*0.99*12.4
      FsPEE[tech,ec,NL,Yr(2024)]=FsPEE[tech,ec,NL,Yr(2024)]*0.0240*0.99*7.8
      FsPEE[tech,ec,NL,Yr(2025)]=FsPEE[tech,ec,NL,Yr(2025)]*0.0296*0.999*8.2
      FsPEE[tech,ec,NL,Yr(2026)]=FsPEE[tech,ec,NL,Yr(2026)]*0.0353*0.99*7.0
      FsPEE[tech,ec,NL,Yr(2027)]=FsPEE[tech,ec,NL,Yr(2027)]*0.0325*0.733*4.8
      FsPEE[tech,ec,NL,Yr(2028)]=FsPEE[tech,ec,NL,Yr(2028)]*0.0342*0.733*4.5
      FsPEE[tech,ec,NL,Yr(2029)]=FsPEE[tech,ec,NL,Yr(2029)]*0.0317*0.732*2.98
      FsPEE[tech,ec,NL,Yr(2030)]=FsPEE[tech,ec,NL,Yr(2030)]*0.0419*0.731*2.3
      FsPEE[tech,ec,NL,Yr(2031)]=FsPEE[tech,ec,NL,Yr(2031)]*0.0499*0.732*1.9
      FsPEE[tech,ec,NL,Yr(2032)]=FsPEE[tech,ec,NL,Yr(2032)]*0.0575*0.732*1.67
      FsPEE[tech,ec,NL,Yr(2033)]=FsPEE[tech,ec,NL,Yr(2033)]*0.0641*0.732*1.50
      FsPEE[tech,ec,NL,Yr(2034)]=FsPEE[tech,ec,NL,Yr(2034)]*0.0617*0.731*2.1
      FsPEE[tech,ec,NL,Yr(2035)]=FsPEE[tech,ec,NL,Yr(2035)]*0.0695*0.732*1.9
      FsPEE[tech,ec,NL,Yr(2036)]=FsPEE[tech,ec,NL,Yr(2036)]*0.0776*0.732*1.7
      FsPEE[tech,ec,NL,Yr(2037)]=FsPEE[tech,ec,NL,Yr(2037)]*0.0809*0.732*1.6
      FsPEE[tech,ec,NL,Yr(2038)]=FsPEE[tech,ec,NL,Yr(2038)]*0.0847*0.732*1.6
      FsPEE[tech,ec,NL,Yr(2039)]=FsPEE[tech,ec,NL,Yr(2039)]*0.0885*0.732*1.5
      FsPEE[tech,ec,NL,Yr(2040)]=FsPEE[tech,ec,NL,Yr(2040)]*0.1719*0.727*1.002
      FsPEE[tech,ec,NL,Yr(2041)]=FsPEE[tech,ec,NL,Yr(2041)]*0.1751*0.732*1.03
      FsPEE[tech,ec,NL,Yr(2042)]=FsPEE[tech,ec,NL,Yr(2042)]*0.1796*0.732*1.02
      FsPEE[tech,ec,NL,Yr(2043)]=FsPEE[tech,ec,NL,Yr(2043)]*0.183*0.732*1.02
      FsPEE[tech,ec,NL,Yr(2044)]=FsPEE[tech,ec,NL,Yr(2044)]*0.1868*0.732*1.01
      FsPEE[tech,ec,NL,Yr(2045)]=FsPEE[tech,ec,NL,Yr(2045)]*0.1909*0.732*1.01
      FsPEE[tech,ec,NL,Yr(2046)]=FsPEE[tech,ec,NL,Yr(2046)]*0.1959*0.732*1.01
      FsPEE[tech,ec,NL,Yr(2047)]=FsPEE[tech,ec,NL,Yr(2047)]*0.2001*0.732*1.007
      FsPEE[tech,ec,NL,Yr(2048)]=FsPEE[tech,ec,NL,Yr(2048)]*0.2043*0.732*1.01
      FsPEE[tech,ec,NL,Yr(2049)]=FsPEE[tech,ec,NL,Yr(2049)]*0.2083*0.732*1.0
      FsPEE[tech,ec,NL,Yr(2050)]=FsPEE[tech,ec,NL,Yr(2050)]*0.2121*0.732*1.0
    end
...
function PolicyControl(db)
  @info("AdjustNLOtherChemicals_A_TOM.jl PolicyControl function called")
  IndPolicy(db)
  MacroPolicy(db)
