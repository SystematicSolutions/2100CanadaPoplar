#
# OGRef.jl - Reference Policies plus OG_Exogenous
#
...
include("SetAsOGReferenceCase.jl")
...
#
# Exogenous Oil & Gas Production
#
include("OG_Exogenous.jl")

function IncorporatePolicies()
  @info "IncorporatePolicies - OGRef"

  SetAsOGReferenceCase.PolicyControl(DB)
