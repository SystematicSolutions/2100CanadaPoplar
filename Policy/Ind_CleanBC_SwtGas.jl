#
# Ind_CleanBC_SwtGas.jl - Device Retrofit
#
...
function AllocateReduction(data::IControl,enduses,techs,ecs,areas,years)
  ...
  # 
  for ec in ecs, year in years
    FractionRemovedAnnually[ec,year] = ReductionAdditional[ec,year] / DmdTotal[ec,year]
  end
...
function IndPolicy(db::String)
  ...
  (; Nation,Tech) = data
  (; AnnualAdjustment,DmdFrac) = data
  (; DInvTechExo,DmdRef,DmdTotal) = data
  ...
  ecs = Select(EC,"SweetGasProcessing")
  techs = Select(Tech,["Coal","Oil","Gas"])

  #
  # Reductions in demand read in in TJ and converted to TBtu
  #  
  ReductionAdditional[ecs,Yr(2022)] = 0.299
  ReductionAdditional[ecs,Yr(2023)] = 0.299
  ReductionAdditional[ecs,Yr(2024)] = 0.299
  ReductionAdditional[ecs,Yr(2025)] = 0.299
  ReductionAdditional[ecs,Yr(2026)] = 0.299
  ReductionAdditional[ecs,Yr(2027)] = 0.299
  ReductionAdditional[ecs,Yr(2028)] = 0.299
  ReductionAdditional[ecs,Yr(2029)] = 0.299
  ReductionAdditional[ecs,Yr(2030)] = 0.299
  ReductionAdditional[ecs,Yr(2031)] = 0.299
  ReductionAdditional[ecs,Yr(2032)] = 0.299
  ReductionAdditional[ecs,Yr(2033)] = 0.299
  ReductionAdditional[ecs,Yr(2034)] = 0.299
  ReductionAdditional[ecs,Yr(2035)] = 0.299
  ReductionAdditional[ecs,Yr(2036)] = 0.299
  ReductionAdditional[ecs,Yr(2037)] = 0.299
  ReductionAdditional[ecs,Yr(2038)] = 0.299
  ReductionAdditional[ecs,Yr(2039)] = 0.299
  ReductionAdditional[ecs,Yr(2040)] = 0.299
  ReductionAdditional[ecs,Yr(2041)] = 0.299
  ReductionAdditional[ecs,Yr(2042)] = 0.299
  ReductionAdditional[ecs,Yr(2043)] = 0.299
  ReductionAdditional[ecs,Yr(2044)] = 0.299
  ReductionAdditional[ecs,Yr(2045)] = 0.299
  ReductionAdditional[ecs,Yr(2046)] = 0.299
  ReductionAdditional[ecs,Yr(2047)] = 0.299
  ReductionAdditional[ecs,Yr(2048)] = 0.299
  ReductionAdditional[ecs,Yr(2049)] = 0.299
  ReductionAdditional[ecs,Yr(2050)] = 0.299

  #
  # Apply an annual adjustment to reductions to compensate for 'rebound' from less retirements
  #  
  AnnualAdjustment[ecs,Yr(2022)] = 0.90
  AnnualAdjustment[ecs,Yr(2023)] = 0.982
  AnnualAdjustment[ecs,Yr(2024)] = 1.05
  AnnualAdjustment[ecs,Yr(2025)] = 1.10
  AnnualAdjustment[ecs,Yr(2026)] = 1.15
  AnnualAdjustment[ecs,Yr(2027)] = 1.20
  AnnualAdjustment[ecs,Yr(2028)] = 1.28
  AnnualAdjustment[ecs,Yr(2029)] = 1.38
  AnnualAdjustment[ecs,Yr(2030)] = 1.48
  AnnualAdjustment[ecs,Yr(2031)] = 1.53
  AnnualAdjustment[ecs,Yr(2032)] = 1.58
  AnnualAdjustment[ecs,Yr(2033)] = 1.635
  AnnualAdjustment[ecs,Yr(2034)] = 1.725
  AnnualAdjustment[ecs,Yr(2035)] = 1.745
  ...
  # Program Costs $M  
  #  
  PolicyCost[ecs,Yr(2022)] = 3.20
  PolicyCost[ecs,Yr(2023)] = 3.20
...
function PolicyControl(db)
  @info "Ind_CleanBC_SwtGas.jl - PolicyControl"
  IndPolicy(db)
end
