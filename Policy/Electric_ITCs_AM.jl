...
# Electric_ITCs_AM.jl
#
# Ref25A - Removed impacts to the last historical year 2023, keep the Clean Electricity ITC in Additional Measures case only - RST 24Apr2025
# Ref24 - Updated with the Ref23AshCER version, removed impacts to the last historical year 2022 - RST 06Aug2024
#

using EnergyModel

module Electric_ITCs_AM
...
function ElecPolicy(db)
  ...
  # Budget 2025 proposes extending the CCUS rates to 2035 rather than 2030 - RST 05Nov2025
  #
...
function PolicyControl(db)
  @info "Electric_ITCs_AM.jl - PolicyControl"
  ElecPolicy(db)
end
