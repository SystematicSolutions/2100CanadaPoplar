#
# Ind_CleanBC_OM.jl - Device Retrofit
...
function IndPolicy(db::String)
  ...
  ecs = Select(EC,"OtherManufacturing")
  techs = Select(Tech,["Coal","Oil","Gas"])

  #
  # Reductions in demand read in in TJ and converted to TBtu
  #  
  ReductionAdditional[ecs,Yr(2024)] = 0.054
  ReductionAdditional[ecs,Yr(2025)] = 0.054
  ReductionAdditional[ecs,Yr(2026)] = 0.054
  ReductionAdditional[ecs,Yr(2027)] = 0.054
  ReductionAdditional[ecs,Yr(2028)] = 0.054
  ReductionAdditional[ecs,Yr(2029)] = 0.054
  ReductionAdditional[ecs,Yr(2030)] = 0.054
  ReductionAdditional[ecs,Yr(2031)] = 0.054
  ReductionAdditional[ecs,Yr(2032)] = 0.054
  ReductionAdditional[ecs,Yr(2033)] = 0.054
  ReductionAdditional[ecs,Yr(2034)] = 0.054
  ReductionAdditional[ecs,Yr(2035)] = 0.054
  ReductionAdditional[ecs,Yr(2036)] = 0.054
  ReductionAdditional[ecs,Yr(2037)] = 0.054
  ReductionAdditional[ecs,Yr(2038)] = 0.054
  ReductionAdditional[ecs,Yr(2039)] = 0.054
  ReductionAdditional[ecs,Yr(2040)] = 0.054
  ReductionAdditional[ecs,Yr(2041)] = 0.054
  ReductionAdditional[ecs,Yr(2042)] = 0.054
  ReductionAdditional[ecs,Yr(2043)] = 0.054
  ReductionAdditional[ecs,Yr(2044)] = 0.054
  ReductionAdditional[ecs,Yr(2045)] = 0.054
  ReductionAdditional[ecs,Yr(2046)] = 0.054
  ReductionAdditional[ecs,Yr(2047)] = 0.054
  ReductionAdditional[ecs,Yr(2048)] = 0.054
  ReductionAdditional[ecs,Yr(2049)] = 0.054
  ReductionAdditional[ecs,Yr(2050)] = 0.054

  #
  # Apply an annual adjustment to reductions to compensate for 'rebound' from less retirements
  #  
  AnnualAdjustment[ecs,Yr(2022)] = 1.55
  AnnualAdjustment[ecs,Yr(2023)] = 1.6
  AnnualAdjustment[ecs,Yr(2024)] = 1.65
  AnnualAdjustment[ecs,Yr(2025)] = 1.70
  AnnualAdjustment[ecs,Yr(2026)] = 1.75
  AnnualAdjustment[ecs,Yr(2027)] = 1.80
  AnnualAdjustment[ecs,Yr(2028)] = 1.85
  AnnualAdjustment[ecs,Yr(2029)] = 1.90
  AnnualAdjustment[ecs,Yr(2030)] = 1.95
  AnnualAdjustment[ecs,Yr(2031)] = 2.00
  AnnualAdjustment[ecs,Yr(2032)] = 2.013
  AnnualAdjustment[ecs,Yr(2033)] = 2.113
  AnnualAdjustment[ecs,Yr(2034)] = 2.209
  AnnualAdjustment[ecs,Yr(2035)] = 2.307
  ...
  # Program Costs $M
  #
  PolicyCost[ecs,Yr(2022)] = 1.75
  PolicyCost[ecs,Yr(2023)] = 1.75
...
function PolicyControl(db)
  @info "Ind_CleanBC_OM.jl - PolicyControl"
  IndPolicy(db)
end
