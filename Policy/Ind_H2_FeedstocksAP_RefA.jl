...
module Ind_H2_FeedstocksAP_RefA
...
function IndPolicy(db)
  ...
  for year in years
    ...
    xFsFrac[Hydrogen,     Gas,Petroleum,        AB,year] = 0.7661
    xFsFrac[NaturalGas,   Gas,Petroleum,        AB,year] = 0.2522
    ...
    xFsFrac[Hydrogen,     Gas,OilSandsUpgraders,AB,year] = 0.5200
    xFsFrac[NaturalGas,   Gas,OilSandsUpgraders,AB,year] = 0.4800
  ...
  tech = Select(Tech,"Gas")
  fuels = Select(Fuel,["Hydrogen","Coke","NaturalGasRaw","RNG","StillGas","LPG"])

  # Set 2029 fractions for QC facility
  xFsFrac[Hydrogen,tech,ec,area,Yr(2029)] = 0.5000
  xFsFrac[Coke,tech,ec,area,Yr(2029)] = 0.5000
  xFsFrac[NaturalGasRaw,tech,ec,area,Yr(2029)] = 0.0000
  xFsFrac[RNG,tech,ec,area,Yr(2029)] = 0.0000
  xFsFrac[StillGas,tech,ec,area,Yr(2029)] = 0.0000
  xFsFrac[LPG,tech,ec,area,Yr(2029)] = 0.0000
...
function PolicyControl(db)
  @info "Ind_H2_FeedstocksAP_RefA.jl - PolicyControl"
  IndPolicy(db)
end
