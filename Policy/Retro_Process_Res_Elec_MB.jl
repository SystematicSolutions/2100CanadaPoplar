#
# Retro_Process_Res_Elec_MB.jl - Process Retrofit
...
module Retro_Process_Res_Elec_MB
...
function ResPolicy(db)
  ...
  Reduction[tech, years] = [
    # 2024    2025    2026    2027    2028    2029    2030    2031    2032    2033    2034    2035    2036    2037    2038    2039    2040    2041    2042    2043    2044    2045    2046    2047    2048    2049    2050
      0.36    0.61    0.83    1.09    1.35    1.61    1.87    2.14    2.41    2.70    3.00    3.32    3.62    3.92    4.22    4.53    4.85    5.17    5.52    5.87    5.87    5.87    5.87    5.87    5.87    5.87    5.87
    ]
  #! format: on
  ...
  for year in years
    Increment[tech,year] = 0.035
  end

  years = collect(Yr(2035):Yr(2045))
  for year in years
    Increment[tech,year] = 0.035
  end
...
function PolicyControl(db)
  @info "Retro_Process_Res_Elec_MB.jl - PolicyControl"
  ResPolicy(db)
end
