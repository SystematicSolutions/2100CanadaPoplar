...
function IndPolicy(db)
  ...
  # OilSandsUpgraders       2027
  xDmFrac[Heat,Hydrogen,     Gas,Petroleum,        AB,Yr(2027)] = 0.2915
  xDmFrac[Heat,NaturalGas,   Gas,Petroleum,        AB,Yr(2027)] = 0.1782
  xDmFrac[Heat,NaturalGasRaw,Gas,Petroleum,        AB,Yr(2027)] = 0.0000
  xDmFrac[Heat,RNG,          Gas,Petroleum,        AB,Yr(2027)] = 0.0000
  xDmFrac[Heat,StillGas,     Gas,Petroleum,        AB,Yr(2027)] = 0.5304

  # OilSandsUpgraders       2027
  xDmFrac[Heat,Hydrogen,Gas,OilSandsUpgraders,AB,Yr(2027)] = 0.1262
  xDmFrac[Heat,NaturalGas,Gas,OilSandsUpgraders,AB,Yr(2027)] = 0.2237
  xDmFrac[Heat,NaturalGasRaw,Gas,OilSandsUpgraders,AB,Yr(2027)] = 0.0000
  xDmFrac[Heat,RNG,Gas,OilSandsUpgraders,AB,Yr(2027)] = 0.0000
  xDmFrac[Heat,StillGas,Gas,OilSandsUpgraders,AB,Yr(2027)] = 0.6201

  for ec in ecs, fuel in fuels, enduse in Enduses
    xDmFrac[enduse,fuel,Gas,ec,AB,Yr(2027)] = xDmFrac[Heat,fuel,Gas,ec,AB,Yr(2027)]
  end
  years = collect(Yr(2028):Yr(2030))
  for year in years, ec in ecs, fuel in fuels, enduse in Enduses
    xDmFrac[enduse,fuel,Gas,ec,AB,year] = xDmFrac[enduse,fuel,Gas,ec,AB,Yr(2027)]
  end
  ...
  Petrochemicals    = Select(EC,"Petrochemicals")
    ...
    # Petrochemicals          2027
  xDmFrac[Heat,Hydrogen,     Gas,Petrochemicals,   AB,Yr(2027)] = 0.0876
  xDmFrac[Heat,NaturalGas,   Gas,Petrochemicals,   AB,Yr(2027)] = 0.8223
  ...
  for year in years, ec in ecs, fuel in fuels, enduse in Enduses
    xDmFrac[enduse,fuel,Gas,ec,AB,year] = xDmFrac[enduse,fuel,Gas,ec,AB,Yr(2027)]
      ...
      # Petrochemicals          2027
  xDmFrac[Heat,Hydrogen,     Gas,Petrochemicals,   AB,Yr(2033)] = 0.3076
  xDmFrac[Heat,NaturalGas,   Gas,Petrochemicals,   AB,Yr(2033)] = 0.7023
  xDmFrac[Heat,NaturalGasRaw,Gas,Petrochemicals,   AB,Yr(2033)] = 0.0000
  xDmFrac[Heat,RNG,          Gas,Petrochemicals,   AB,Yr(2033)] = 0.0000
  xDmFrac[Heat,StillGas,     Gas,Petrochemicals,   AB,Yr(2033)] = 0.0000
  ...
  for year in years, ec in ecs, fuel in fuels, enduse in Enduses
    ...
    DmFracMax[enduse,fuel,Gas,ec,AB,year] =
      xDmFrac[enduse,fuel,Gas,ec,AB,year]*1.05
    DmFracMin[enduse,fuel,Gas,ec,AB,year] =
      xDmFrac[enduse,fuel,Gas,ec,AB,year]*1.05
  end
  #
  ...
  # Petrochemicals          2027
  xDmFrac[Heat,Hydrogen,     Gas,Petrochemicals,AB,Yr(2027)] = 0.5076
  xDmFrac[Heat,NaturalGas,   Gas,Petrochemicals,AB,Yr(2027)] = 0.5023
  xDmFrac[Heat,NaturalGasRaw,Gas,Petrochemicals,AB,Yr(2027)] = 0.0000
  xDmFrac[Heat,RNG,          Gas,Petrochemicals,AB,Yr(2027)] = 0.0000
  xDmFrac[Heat,StillGas,     Gas,Petrochemicals,AB,Yr(2027)] = 0.0000
...
function PolicyControl(db)
  @info "Ind_H2_DemandsAP_RefA.jl - PolicyControl"
  IndPolicy(db)
end
