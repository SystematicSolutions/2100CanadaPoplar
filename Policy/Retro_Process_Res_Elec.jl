...
function ResPolicy(db)
  ...
  Reduction[tech, years] = [
    # 2024    2025    2026    2027    2028    2029    2030    2031    2032    2033    2034    2035    2036    2037    2038    2039    2040    2041    2042    2043    2044    2045    2046    2047    2048    2049    2050
      0.30    0.61    1.48    2.97    4.52    6.10    7.70    9.30    10.9    12.5    14.1    15.4    16.7    17.4    17.5    17.6    17.6    17.6    17.6    17.6    17.6    17.6    17.7    17.7    17.7    17.7    17.8
    ]
  #! format: on
  ...
  for year in years
    Increment[tech,year] = 0.01
  end

  years = collect(Yr(2026):Yr(2029))
  for year in years
    Increment[tech,year] = 0.0006
  end

  years = collect(Yr(2030):Yr(2035))
  for year in years
    Increment[tech,year] = 0.14
  end
  ...
  years = collect(Yr(2040):Yr(2040))
  for year in years
    Increment[tech,year] = 3.40
  end

  years = collect(Yr(2041):Yr(2042))
  for year in years
    Increment[tech,year] = 5.25
  end

  years = collect(Yr(2043):Yr(2045))
  for year in years
    Increment[tech,year] = 5.50
  end
  ...
  Expenses[tech, years] = [
    #2024    2025    2026    2027    2028    2029    2030    2031    2032    2033    2034    2035    2036    2037    2038    2039    2040    2041    2042    2043    2044    2045    2046    2047    2048    2049    2050
    15.7    16.1    16.4    16.7    17.0    17.4    17.7    18.1    18.4    18.8    19.2    19.6    20.0    20.4    20.8    21.2    21.6    22.0    22.5    22.9    23.4    23.9    24.3    24.8    25.3    25.8    26.3
  ]
  for year in years
