...
Base.@kwdef struct MControl
  ...
  # Scratch Variables
  ReductionInput::VariableArray{1} = zeros(Float32,length(Year)) # [Year] Reductions Input
end
...
Base.@kwdef struct CControl
  ...
  # Scratch Variables
  Expenses::VariableArray{1} = zeros(Float32,length(Year)) # [Year] Program Expenses (2018 CN$M)
end
