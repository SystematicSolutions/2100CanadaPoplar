#
# Retro_Process_Com_Elec_MB.jl - Process Retrofit
# Electricity Conservation Framework, Commercial Buildings Process Improvements
# Input direct energy savings and expenditures provided from MB Hydro
#
#
...
module Retro_Process_Com_Elec_MB
...
function ComPolicy(db)
  ...
  Reduction[tech, years] = [
    # 2024    2025    2026    2027    2028    2029    2030    2031    2032    2033    2034    2035    2036    2037    2038    2039    2040    2041    2042    2043    2044    2045    2046    2047    2048    2049    2050
      0.27    0.45    0.62    0.82    1.01    1.21    1.41    1.61    1.82    2.04    2.27    2.51    2.76    2.99    3.24    3.50    3.76    4.03    4.32    4.61    4.61    4.61    4.61    4.61    4.61    4.61    4.61
    ]
  #! format: on
...
function PolicyControl(db)
  @info "Retro_Process_Com_Elec_MB.jl - PolicyControl"
  ComPolicy(db)
end
