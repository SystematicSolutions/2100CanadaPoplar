#
# Res_Conv_CGBS_Option1.jl - based on ResCom_MS_Conversions.txp and ResCom_CGBS_Conversions_Option1
#
...
function PolicyControl(db)
  @info "Res_Conv_CGBS_Option1.jl - PolicyControl"
  ResPolicy(db)
end
