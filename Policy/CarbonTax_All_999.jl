#
# CarbonTax_All_999.jl - Federal Carbon Levy
#

using EnergyModel

module CarbonTax_All_999
...
function ElecPolicy(db)
  ...
  for year in years
    xETAPr[market,year] = 999*xInflationNation[CN,year]/
...
function PolicyControl(db)
  @info "CarbonTax_All_999.jl - PolicyControl"
  ElecPolicy(db)
end
