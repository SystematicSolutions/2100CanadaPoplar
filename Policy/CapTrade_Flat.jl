#
# CapTrade_Flat.jl - Endogenous Carbon Tax
#

using EnergyModel

module CapTrade_Flat
...
function ElecPolicy(db)
  ...
  #
  # Emissions goal is exogenous (GoalPolSw=0)
  #
  GoalPolSw[market] = 0
  ...
  xGoalPol[market,Yr(2034)] = 461e6   
  xGoalPol[market,Yr(2035)] = 461e6  
  xGoalPol[market,Yr(2040)] = 461e6  
  xGoalPol[market,Yr(2041)] = 461e6    
  xGoalPol[market,Yr(2045)] = 461e6  
  xGoalPol[market,Yr(2050)] = 461e6
  ...
  # easily estimate the values - Jeff Amlin 8/14/25
  #
  years = collect(Current:YrFinal)
...
function PolicyControl(db)
  @info "CapTrade_Flat.jl - PolicyControl"
  ElecPolicy(db)
end
