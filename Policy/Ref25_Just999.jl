#
# Ref25_Just999.jl - Ref25 with just a $999 eCO2 price.  No ITC, No CFR
#
...
include("CFS_LiquidPrice_zero.jl")
...
include("CarbonTax_All_999.jl")

function IncorporatePolicies()
  @info "IncorporatePolicies Ref25_Just999"
  ...
  CFS_LiquidPrice_zero.PolicyControl(DB)
  ...
  CarbonTax_All_999.PolicyControl(DB)
