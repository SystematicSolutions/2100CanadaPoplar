#
# CarbonTax_All_400.jl - Federal Carbon Levy
#

using EnergyModel

module CarbonTax_All_400
...
function ElecPolicy(db)
  ...
  areas = Select(Area,["AB","MB","BC","ON","QC","SK","NS","NL","NB","PE","YT","NU","NT"])
  for year in years, area in areas
  ...
  # for year in years
  #   PCovMarket[Flaring,market,year] = 0
  # end
  ...
  for year in years
    xETAPr[market,year] = 400*xInflationNation[CN,year]/
      xInflationNation[CN,Yr(2025)]/xExchangeRateNation[CN,year]/xInflationNation[US,year]
  end
...
function PolicyControl(db)
  @info "CarbonTax_All_400.jl - PolicyControl"
  ElecPolicy(db)
end
