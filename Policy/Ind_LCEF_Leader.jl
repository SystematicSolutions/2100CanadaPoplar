...
function IndPolicy(db::String)
  ...
  (; ANMap,AnnualAdjustment,DInvTechExo,DmdFrac,DmdRef,DmdTotal) = data
  ...
  for enduse in enduses, tech in techs, ec in ECs, area in areas, year in years
    ...
    DInvTechExo[enduse,tech,ec,area,year] = DInvTechExo[enduse,tech,ec,area,year]+PolicyCost[year]*
