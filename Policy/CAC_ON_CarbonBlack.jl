...
#
# This file models Ontario's Carbon Black Industry Standard for Cabot Canada Ltd. located in Sarnia and Birla Carbon in Hamilton.
...
Base.@kwdef struct CAC_ON_CarbonBlackData
  ...
  # Scratch Variable
  tmp::VariableArray{1} = zeros(Float32,length(Years))
end
...
function CAC_ON_CarbonBlackDataPolicy(db)
  ...
  xGoalPol[154,years] = [4110   1214   1243   1268   1292   1315   1336   1354   1364   1380   1414   1452   1488   1488   1488   1488   1488   1488   1488   1488   1488   1488   1488]
...
function PolicyControl(db)
  ...
  CAC_ON_CarbonBlackDataPolicy(db)
end
