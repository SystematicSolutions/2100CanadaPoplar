#
#  NRCan_Elec_EmergingRenewables_2.jl - NRCan Clean Electricity Policy 
#

using EnergyModel

module NRCan_Elec_EmergingRenewables_2
...
function ElecPolicy(db)
  ...
  #                                      Online  xUnGCCI
  #                 Unit Code             Year      kw
  AddCapacity(data,"SK_New_Geo",          2025,   20000)
  AddCapacity(data,"AB_New_Geo",          2025,   20000)
  AddCapacity(data,"BC_New_Geo",          2025,   20000)
  AddCapacity(data,"BC_New_Hydro",        2025,   20000)
  AddCapacity(data,"NL_New_Hydro",        2025,   20000)
  AddCapacity(data,"MB_New_Hydro",        2025,   20000)
  AddCapacity(data,"NB_New_SolarPV",      2025,   20000)
  AddCapacity(data,"SK_New_SolarPV",      2025,   20000)
  AddCapacity(data,"BC_New_SolarPV",      2025,   20000)
  AddCapacity(data,"MB_New_SolarPV",      2025,   20000)
  AddCapacity(data,"NL_New_SolarPV",      2025,   10000) 
...
function PolicyControl(db)
  @info "NRCan_Elec_EmergingRenewables_2.jl - PolicyControl"
