...
function TransPolicy(db)
  ...
  Temps[enduse,techs,ec,area,years] = [
    ...
    1.015  1.015  1.046  1.062  1.108  1.108  1.108  1.000  1.014  1.000  1.020  1.034  1.047  1.060 # HDV2B3Gasoline
    1.026  1.04   1.066  1.105  1.158  1.158  1.158  1.000  1.014  1.000  1.020  1.034  1.047  1.060 # HDV2B3Diesel
  ...
  for year in Years, tech in techs, area in areas
    DEStdP[enduse,tech,ec,area,year] = DEStdP[enduse,tech,ec,ON,year]
  end
