...
Base.@kwdef struct IControl
  ...
  ECFP0Ref::VariableArray{4} = ReadDisk(OGRefNameDB,"$Outpt/ECFP",First) # [Enduse,Tech,EC,Area,First] Fuel Price ($/mmBtu)
  ECFPFuelRef::VariableArray{4} = ReadDisk(OGRefNameDB,"$Outpt/ECFPFuel") # [Fuel,EC,Area,Year] Fuel Price ($/mmBtu)
