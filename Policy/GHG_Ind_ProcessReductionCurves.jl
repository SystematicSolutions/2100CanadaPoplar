...
function MacroPolicy(db)
  ...
  MEC0[Aluminum,PFC,areas,Yr(2020)] = MEC0[Aluminum,PFC,areas,Yr(2020)] * (1-0.40)
  MEC0[Aluminum,PFC,areas,Yr(2020)] = MEC0[Aluminum,PFC,areas,Yr(2020)] * (1-0.41)
  InterpolateCoefficients(data,Aluminum,PFC,areas)
  # 
  ...
  MEC0[OtherNonferrous,SF6,areas,Yr(2020)] = MEC0[OtherNonferrous,SF6,areas,Yr(2020)] * (1-0.98)
  MEC0[OtherNonferrous,SF6,areas,Yr(2020)] = MEC0[OtherNonferrous,SF6,areas,Yr(2020)] * (1-0.98)
  InterpolateCoefficients(data,OtherNonferrous,SF6,areas)
  # 
  ...
  MEC0[UtilityGen,SF6,areas,Yr(2020)] = MEC0[UtilityGen,SF6,areas,Yr(2020)] * (1-0.42)
  MEC0[UtilityGen,SF6,areas,Yr(2020)] = MEC0[UtilityGen,SF6,areas,Yr(2020)] * (1-0.42)
  InterpolateCoefficients(data,UtilityGen,SF6,areas)
  # 
  ...
  MEC0[CoalMining,CH4,areas,Yr(2020)] = MEC0[CoalMining,CH4,areas,Yr(2020)] * 
    (1-0.59)
  MEC0[CoalMining,CH4,areas,Yr(2020)] = MEC0[CoalMining,CH4,areas,Yr(2020)] * 
    (1-0.57)
  InterpolateCoefficients(data,CoalMining,CH4,areas)
  # 
  ...
  MEC0[OtherManufacturing,SF6,areas,Yr(2020)] = MEC0[OtherManufacturing,SF6,areas,Yr(2020)] * (1-0.07)
  MEC0[OtherManufacturing,SF6,areas,Yr(2020)] = MEC0[OtherManufacturing,SF6,areas,Yr(2020)] * (1-0.04)
  InterpolateCoefficients(data,OtherManufacturing,SF6,areas)
  # 
  MECoeff[:,Yr(2010)] = [16.04980207,  -1.056183671 ,  0.705728166]
  MECoeff[:,Yr(2020)] = [105.0311018,  -1.133560846,  0.236699947]
  MECoeff[:,Yr(2030)] = [83.20436779,  -0.903121774,  0.186493423]
  MEC0[OtherManufacturing,PFC,areas,Yr(2020)] = MEC0[OtherManufacturing,PFC,areas,Yr(2020)] * (1-0.07)
  MEC0[OtherManufacturing,PFC,areas,Yr(2020)] = MEC0[OtherManufacturing,PFC,areas,Yr(2020)] * (1-0.04)
  InterpolateCoefficients(data,OtherManufacturing,PFC,areas)
  # 
  ...
  MEC0[Fertilizer,N2O,areas,Yr(2020)] = MEC0[Fertilizer,N2O,areas,Yr(2020)] * (1-0.76)
  MEC0[Fertilizer,N2O,areas,Yr(2020)] = MEC0[Fertilizer,N2O,areas,Yr(2020)] * (1-0.76)
  InterpolateCoefficients(data,Fertilizer,N2O,areas)
