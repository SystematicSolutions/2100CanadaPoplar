#
#  Electric_NRCan_SmallCommunities.jl
#

using EnergyModel

module Electric_NRCan_SmallCommunities
...
function ElecPolicy(db)
  ...
  AddCapacity(data,"AB_New_SolarPV",      2025,   2353)
  AddCapacity(data,"BC_New_SolarPV",      2025,   2470)
  AddCapacity(data,"BC_New_Hydro",        2025,    700)
  AddCapacity(data,"NS_New_Hydro",        2025,    240)
  AddCapacity(data,"NS_New_SolarPV",      2025,    189)
  AddCapacity(data,"NU_New_OnshoreWind",  2025,   1000)
  AddCapacity(data,"NU_New_SolarPV",      2025,    134)
  AddCapacity(data,"ON_New_SolarPV",      2025,    650)
  AddCapacity(data,"PE_New_OnshoreWind",  2025,   1000)
  AddCapacity(data,"QC_New_Hydro",        2025,   7500)
  AddCapacity(data,"YT_New_OnshoreWind",  2025,   4900)
  AddCapacity(data,"YT_New_SolarPV",      2025,   1900)
...
function PolicyControl(db)
  @info "Electric_NRCan_SmallCommunities.jl - PolicyControl"
  ElecPolicy(db)
end
