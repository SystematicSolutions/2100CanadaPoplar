#
#  Electric_NRCan_EmergingRenewables.jl - NRCan Clean Electricity Policy 
#
...
module Electric_NRCan_EmergingRenewables
...
function ElecPolicy(db)
  ...
  #
  # Edited by Thomas: (consultation Ref24)
  #                                     1.      Suffield Solar, Bifacial solar power generating facility, Alberta, 23 MW, commissioned in 2021
  ...
  #
  # Edited by Thomas: (consultation Ref25)
  #                   Comments from NRCAN have been implemented below (See consultation tracker item #842)
  #
  #                               Year xUnGCCI (kW)
  # AddCapacity(data,"SK_New_Geo",  2026,  5000) <-- already in vData: SK_DEEP_Geo
...
function PolicyControl(db)
  @info "Electric_NRCan_EmergingRenewables.jl - PolicyControl"
