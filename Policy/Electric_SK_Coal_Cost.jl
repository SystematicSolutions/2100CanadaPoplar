#
# Electric_SK_Coal_Cost.jl
#

using EnergyModel

module Electric_SK_Coal_Cost
...
function ElecPolicy(db)
  ...
  # Boundary Dam 3
  #  
  units = Select(UnCode,"SK_Boundry3_CCS")
  ...
  #  
  #units = Select(UnCode,["SK_Boundry4_CCS","SK_Boundry5_CCS"])
  #for year in Years, unit in units
  ...
  # Boundary Dam 6
  #  
  #units = Select(UnCode,"SK_Boundry6_CCS")
  #for year in Years, unit in units
...
function PolicyControl(db)
  @info "Electric_SK_Coal_Cost.jl - PolicyControl"
  ElecPolicy(db)
end
