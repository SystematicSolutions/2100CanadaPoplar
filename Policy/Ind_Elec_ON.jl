...
# Input direct energy savings and expenditures from IESO
# This file targets Ontario
...
function IndPolicy(db)
  ...
  Reduction[tech, years] = [
    # 2024    2025    2026    2027    2028    2029    2030    2031    2032    2033    2034    2035    2036    2037    2038    2039    2040    2041    2042    2043    2044    2045    2046    2047    2048    2049    2050
      0.26    0.50    1.16    2.47    3.84    5.27    6.75    8.25    9.79    11.4    13.0    14.3    15.7    16.5    16.8    17.0    17.2    17.6    17.4    17.7    17.9    18.1    18.2    18.4    18.5    18.7    18.9
    ]
  #! format: on
  ...
  for year in years
    Increment[tech,year] = 0.09
  end

   years = collect(Yr(2036):Yr(2042))
  for year in years
    Increment[tech,year] = 1.15
  end

  years = collect(Yr(2043):Final)
  for year in years
...
function PolicyControl(db)
  @info "Ind_Elec_ON.jl - PolicyControl"
  IndPolicy(db)
end
