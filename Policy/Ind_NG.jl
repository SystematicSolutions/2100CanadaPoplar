#
# Ind_NG.txp - Process Retrofit to simulate ON natural gas conservation frameworks
# Input direct energy savings and expenditures provided by Ontario
# see ON_CDM_DSM3.xlsx (RW 09/16/2021)
# Edited by RST (05Oct2022), tuning for Ref22 & cost/reduction updates, after Randy's fix for Disk Reading
#
