...
# Alberta (AB) - Emergency Power
  ...
  for unit in units
    ...
    UnEAF[unit,month,Yr(2026)] *= 1.012
    UnEAF[unit,month,Yr(2027)] *= 1.004
  end
  # UnEAF Winter
  month = Select(Month,"Winter")
  for unit in units
    ...
    UnEAF[unit,month,Yr(2026)] *= 1.15
    UnEAF[unit,month,Yr(2027)] *= 1.08
    UnEAF[unit,month,Yr(2028)] *= 1.31
  end
  # Thermal power
  # UnOR OGSteam
  ...
  for unit in units
    ...
    UnOR[unit,1,month,Yr(2027)] = UnOR[unit,1,month,Yr(2027)] * 0.5
    UnOR[unit,2,month,Yr(2027)] = UnOR[unit,2,month,Yr(2027)] * 0.5
  end
  month = Select(Month,"Winter")
  for unit in units
    UnOR[unit,1,month,Yr(2024)] = UnOR[unit,1,month,Yr(2024)] * 0.5
    ...
    UnOR[unit,1,month,Yr(2025)] = UnOR[unit,1,month,Yr(2025)] * 0.5
    UnOR[unit,2,month,Yr(2025)] = UnOR[unit,2,month,Yr(2025)] * 0.5
    UnOR[unit,1,month,Yr(2026)] = UnOR[unit,1,month,Yr(2026)] * 0.2
    UnOR[unit,2,month,Yr(2026)] = UnOR[unit,2,month,Yr(2026)] * 0.2
    UnOR[unit,1,month,Yr(2027)] = UnOR[unit,1,month,Yr(2027)] * 0.5
    UnOR[unit,2,month,Yr(2027)] = UnOR[unit,2,month,Yr(2027)] * 0.5
    UnOR[unit,1,month,Yr(2028)] = UnOR[unit,1,month,Yr(2028)] * 0
    UnOR[unit,2,month,Yr(2028)] = UnOR[unit,2,month,Yr(2028)] * 0
  end
  # UnOR OGCT
...
function PolicyControl(db)
  @info "Electric_Patch_AM.jl - PolicyControl"
  ElecPolicy(db)
end
