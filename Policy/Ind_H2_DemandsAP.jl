...
function IndPolicy(db)
  ...
  xDmFrac[Heat,Hydrogen,     Gas,Petroleum,        AB,Yr(2027)] = 0.2515
  ...
  xDmFrac[Heat,StillGas,     Gas,Petroleum,        AB,Yr(2027)] = 0.5704
  ...
  Petrochemicals    = Select(EC,"Petrochemicals")
    ...
    # Petrochemicals          2027
  xDmFrac[Heat,Hydrogen,     Gas,Petrochemicals,   AB,Yr(2027)] = 0.0576
  xDmFrac[Heat,NaturalGas,   Gas,Petrochemicals,   AB,Yr(2027)] = 0.8523
  ...
  for year in years, ec in ecs, fuel in fuels, enduse in Enduses
    xDmFrac[enduse,fuel,Gas,ec,AB,year] = xDmFrac[enduse,fuel,Gas,ec,AB,Yr(2027)]
      ...
      # Petrochemicals          2027
  xDmFrac[Heat,Hydrogen,     Gas,Petrochemicals,   AB,Yr(2033)] = 0.0776
  xDmFrac[Heat,NaturalGas,   Gas,Petrochemicals,   AB,Yr(2033)] = 0.8323
