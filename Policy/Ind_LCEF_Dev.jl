#
# Ind_LCEF_Dev.jl - Simulates investments into decarbonizing SweetGasProcessing.
...
# Reductions for Non-Ferrous Metals in Alberta was removed due to insufficient energy demand to effect the policy- 15th/09/25 Tim
#
...
function IndPolicy(db::String)
  ...
  ReductionAdditional[ec,area,Yr(2036)] = 0.12
  ReductionAdditional[ec,area,Yr(2037)] = 0.12
  ReductionAdditional[ec,area,Yr(2038)] = 0.12
  ...
  ReductionAdditional[ec,area,Yr(2037)] = 2.56
