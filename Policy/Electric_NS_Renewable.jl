#
# Electric_NS_Renewable.jl - Nova Scotia Renewable Portfolio Standard (RPS) for electric generation
#
...
function PolicyControl(db)
  @info "Electric_NS_Renewable.jl - PolicyControl"
  ElecPolicy(db)
end
