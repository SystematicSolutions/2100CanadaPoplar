#
# CFS_LiquidPrice_S260.jl
#

using EnergyModel

module CFS_LiquidPrice_S260
...
function SupplyPolicy(db)
  ...
  for year in years
    ETADAP[market,year] = 350/xExchangeRateNation[CN,year]/
      xInflationNation[US,year]
  end
...
function PolicyControl(db)
  @info "CFS_LiquidPrice_S260.jl - PolicyControl"
  SupplyPolicy(db)
end
