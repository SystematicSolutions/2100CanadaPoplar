...
Base.@kwdef struct MControl
  ...
  # Scratch Variables
  Animal_CH4_Target::VariableArray{2} = zeros(Float32,length(Area),length(Year)) # [Area,Year] Target CH4 reduction (kt) from animal production (total 0.24Mt CO2e in 2030)
end
