#
# GHG_CCSCurves_RefA.jl
#

using EnergyModel

module GHG_CCSCurves_RefA
...
function MacroPolicy(db)
  ...
  # For Ref25A, need to adjust Petroleum C0 (above) in order to include
  # exogenous CCS project's Fed-coop and Polaris
  # 
  @. SqC0Mult = 1
...
function PolicyControl(db)
  @info "GHG_CCSCurves_RefA.jl - PolicyControl"
  MacroPolicy(db)
  IndPolicy(db)
end
