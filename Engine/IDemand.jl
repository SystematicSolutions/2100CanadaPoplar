...
Base.@kwdef struct Data
  ...
  BCMult::VariableArray{3} = ReadDisk(db,"SInput/BCMult",year); # Fuel Emission Multipler between Black Carbon and PM 2.5 (Tonnes/Tonnes) [Fuel,ECC,Area]
  ...
  CM::VariableArray{3} = ReadDisk(db,"$Input/CM") # Cross-over Reduction Multiplier (Tonnes/Tonnes) [FuelEP,Poll,PollX]
  ...
  ExpCP::VariableArray{3} = ReadDisk(db,"$Outpt/ExpCP",year) # Emission Expenditures ($M/Yr) [FuelEP,EC,Area]
  ...
  FsDem::VariableArray{3} = ReadDisk(db,"$Outpt/FsDem",year) # Feedstock Demands (TBtu/Yr) [Fuel,EC,Area]
  ...
  FsPOCA::VariableArray{4} = ReadDisk(db,"$Outpt/FsPOCA",year) # Feedstock Pollution Coefficients (Tonnes/TBtu) [Fuel,EC,Poll,Area]
  FsPOCS::VariableArray{4} = ReadDisk(db,"$Input/FsPOCS",year) # Feedstock Pollution Standards (Tonnes/TBtu) [Fuel,EC,Poll,Area]
  FsPOCX::VariableArray{4} = ReadDisk(db,"$Input/FsPOCX",year) # Feedstock Marginal Pollution Coefficients (Tonnes/TBtu) [Fuel,EC,Poll,Area]
  FsPol::VariableArray{4} = ReadDisk(db,"$Outpt/FsPol",year) # Feedstock Pollution (Tonnes/Yr) [Fuel,EC,Poll,Area]
  ...
  IPCost::VariableArray{4} = ReadDisk(db,"$Outpt/IPCost",year) # Indicated Permit Cost ($/Tonne) [FuelEP,EC,Poll,Area]
  IRP::VariableArray{4} = ReadDisk(db,"$Outpt/IRP",year) # Indicated Pollutant Reduction (Tonnes/Tonnes) [FuelEP,EC,Poll,Area]
  ...
  PCCov::VariableArray{4} = ReadDisk(db,"$Outpt/PCCov",year) # Emissions Coverage by Tech or Fuel (Tonnes/Tonnes) [FuelEP,EC,Poll,Area]
  ...
  PCost::VariableArray{4} = ReadDisk(db,"$Outpt/PCost",year) # Permit Cost ($/Tonne) [FuelEP,EC,Poll,Area]
  PCostECC::VariableArray{3} = ReadDisk(db,"SOutput/PCost",year) # Permit Cost ($/Tonne) [ECC,Poll,Area]
  PCostExo::VariableArray{4} = ReadDisk(db,"$Input/PCostExo",year) # Marginal Exogenous Permit Cost (Real $/Tonnes) [FuelEP,EC,Poll,Area]
  PCostM::VariableArray{4} = ReadDisk(db,"$Input/PCostM",year) # Permit Cost Multiplier ($/Tonne/$/Tonne) [FuelEP,EC,Poll,Area]
  PCostN::VariableArray{4} = ReadDisk(db,"$Input/PCostN") # Pollution Reduction Cost Normal ($/Tonne) [FuelEP,EC,Poll,Area]
  ...
  POCA::VariableArray{5} = ReadDisk(db,"$Outpt/POCA",year) # Average Pollution Coefficients (Tonnes/TBtu) [Enduse,FuelEP,EC,Poll,Area]
  POCAPrior::VariableArray{5} = ReadDisk(db,"$Outpt/POCA",prior) # Average Pollution Coefficients (Tonnes/TBtu) [Enduse,FuelEP,EC,Poll,Area]
  POCF::VariableArray{4} = ReadDisk(db,"$CalDB/POCF") # Process Operating Cost Fraction ($/Yr/$) [Enduse,Tech,EC,Area]
  POCS::VariableArray{5} = ReadDisk(db,"$Input/POCS",year) # Pollution Standards (Tonnes/TBtu) [Enduse,FuelEP,EC,Poll,Area]
  POCX::VariableArray{5} = ReadDisk(db,"$Input/POCX",year) # Marginal Pollution Coefficients (Tonnes/TBtu) [Enduse,FuelEP,EC,Poll,Area]
  POEM::VariableArray{5} = ReadDisk(db,"$Outpt/POEM",year) # Embodied Pollution (Tonnes/Yr) [Enduse,FuelEP,EC,Poll,Area]
  POEMPrior::VariableArray{5} = ReadDisk(db,"$Outpt/POEM",prior) # Embodied Pollution (Tonnes/Yr) [Enduse,FuelEP,EC,Poll,Area]
  ...
  PolMarginal::VariableArray{4} = ReadDisk(db,"$Outpt/PolMarginal",year) # Marginal Emissions (Tonnes/Yr) [FuelEP,EC,Poll,Area]
  PolSw::VariableArray{4} = ReadDisk(db,"$Input/PolSw",year) # Switch for Pollution Coefficients [Tech,EC,Poll,Area]
  Polute::VariableArray{5} = ReadDisk(db,"$CalDB/Polute",year) # Pollution (Tonnes/Yr) [Enduse,FuelEP,EC,Poll,Area]
  ...
  PVF::VariableArray{4} = ReadDisk(db,"$Input/PVF") # Pollution Reduction Variance Factor (($/Tonne)/($/Tonne)) [FuelEP,EC,Poll,Area]
  RCap::VariableArray{4} = ReadDisk(db,"$Outpt/RCap",year) # Reduction Capital (Tonnes/Yr) [FuelEP,EC,Poll,Area]
  RCapPrior::VariableArray{4} = ReadDisk(db,"$Outpt/RCap",prior) # Reduction Capital (Tonnes/Yr) [FuelEP,EC,Poll,Area]
  RCC::VariableArray{4} = ReadDisk(db,"$Outpt/RCC",year) # Reduction Capital Cost ($/Tonne) [FuelEP,EC,Poll,Area]
  RCCEm::VariableArray{4} = ReadDisk(db,"$Outpt/RCCEm",year) # Embedied Reduction Capital Cost ($) [FuelEP,EC,Poll,Area]
  RCCEmPrior::VariableArray{4} = ReadDisk(db,"$Outpt/RCCEm",prior) # Embedied Reduction Capital Cost ($) [FuelEP,EC,Poll,Area]
  RCD::VariableArray{2} = ReadDisk(db,"$Input/RCD") # Reduction Capital Construction Delay (Years) [EC,Poll]
  RCI::VariableArray{4} = ReadDisk(db,"$Outpt/RCI",year) # Reduction Capital Initiation (Tonnes/Yr/Yr) [FuelEP,EC,Poll,Area]
  RCostM::VariableArray{2} = ReadDisk(db,"$Input/RCostM",year) # Reduction Cost Technology Multiplier ($/$) [FuelEP,Poll]
  RCPL::VariableArray{2} = ReadDisk(db,"$Input/RCPL") # Reduction Capital Pysical Life (Years) [EC,Poll]
  RCR::VariableArray{4} = ReadDisk(db,"$Outpt/RCR",year) # Reduction Capital Completion Rate (Tonnes/Yr/Yr) [FuelEP,EC,Poll,Area]
  RCRPrior::VariableArray{4} = ReadDisk(db,"$Outpt/RCR",prior) # Reduction Capital Completion Rate (Tonnes/Yr/Yr) [FuelEP,EC,Poll,Area]
  ...
  RICap::VariableArray{4} = ReadDisk(db,"$Outpt/RICap",year) # Indicated Reduction Capital (Tonnes/Yr) [FuelEP,EC,Poll,Area]
  RInv::VariableArray{2} = ReadDisk(db,"SOutput/RInv",year) # Emission Reduction Investments (M$/Yr) [ECC,Area]
  RM::VariableArray{4} = ReadDisk(db,"$Outpt/RM",year) # Reduction Multiplier (Tonnes/Tonnes) [FuelEP,EC,Poll,Area]
  RMPrior::VariableArray{4} = ReadDisk(db,"$Outpt/RM",prior) # Reduction Multiplier (Tonnes/Tonnes) [FuelEP,EC,Poll,Area]
  ROCF::VariableArray{4} = ReadDisk(db,"$Input/ROCF") # Polution Reducution O&M ($/Tonne) [FuelEP,EC,Poll,Area]
  ...
  RP::VariableArray{4} = ReadDisk(db,"$Outpt/RP",year) # Pollutant Reduction (Tonnes/Tonnes) [FuelEP,EC,Poll,Area]
  ...
  RPPrior::VariableArray{4} = ReadDisk(db,"$Outpt/RP",prior) # Pollutant Reduction (Tonnes/Tonnes) [FuelEP,EC,Poll,Area]
  ...
  VR::VariableArray{4} = ReadDisk(db,"$Outpt/VR",year) # Voluntary Reduction Policy (Tonnes/Tonnes) [FuelEP,EC,Poll,Area]
  VRP::VariableArray{4} = ReadDisk(db,"$Input/VRP",year) # Voluntary Reduction Policy (Tonnes/Tonnes) [FuelEP,EC,Poll,Area]
  VRPrior::VariableArray{4} = ReadDisk(db,"$Outpt/VR",prior) # Voluntary Reduction Policy (Tonnes/Tonnes) [FuelEP,EC,Poll,Area]
  ...
  xPolute::VariableArray{5} = ReadDisk(db,"$Input/xPolute",year) # Exogenous Pollution Adjustment (Tonnes/Yr) [Enduse,FuelEP,EC,Poll,Area]
  ...
  xRM::VariableArray{4} = ReadDisk(db,"$Input/xRM",year) # Exogenous Average Pollution Coefficient Reduction Multiplier (Tonnes/Tonnes) [FuelEP,EC,Poll,Area]
  ...
  DCCRP::VariableArray{3} = zeros(Float32,length(FuelEP),length(EC),length(Area)); # [FuelFP,EC,Area]
  ...
  GrossEnFPol::VariableArray{4} = zeros(Float32,length(FuelEP),length(EC),length(Poll),length(Area)) # [FuelEP,EC,Poll,Area] Energy Emissions before Reductions (Tonnes/Yr)
  ...
  PCCovTemp::VariableArray{5} = zeros(Float32,length(FuelEP),length(EC),length(Poll),length(PCov),length(Area));
  ...
  POEMA::VariableArray{5} = zeros(Float32,length(Enduse),length(FuelEP),length(EC),length(Poll),length(Area)) # Pollution Additions (Tonnes/Yr) [enduse,fuelep,ec,poll,area]
  POEMR::VariableArray{5} = zeros(Float32,length(Enduse),length(FuelEP),length(EC),length(Poll),length(Area)) # Pollution Retirements (Tonnes/Yr) [enduse,fuelep,ec,poll,area]
  ProcSw::VariableArray{1} = zeros(Float32,length(PI)) #[PI,Year] "Procedure on/off Switch"
  RPFull::VariableArray{4} = zeros(Float32,length(FuelEP),length(EC),length(Poll),length(Area)); # (FuelEP,EC,Poll,Area)
...
function PRReductions(data::Data)
  (; db,year) = data
  (; Areas,EC,ECs,ECC,Enduses,FuelEPs,Markets) = data
  (; PCovs,Polls,PollXs,Techs) = data
  ...
  (; PCostPrior,PCovMap,POCS,POCX,PollMarket,PVF,RCC) = data
  (; RCD,RCostM,RM,ROCF,RP,RPCSw,RPEI,RPEIX,RPFull) = data
  (; RPolECC,RPolicy,VR,VRP,VRPrior,VRRT,xRM) = data
  ...
  for ec in ECs
    ...
    for area in Areas,poll in Polls,fuelep in FuelEPs
      for pcov in PCovs
        PCCovTemp[fuelep,ec,poll,pcov,area] = (ECoverage[ec,poll,pcov,area]*
          PCovMap[fuelep,ecc,pcov,area])
      end
      PCCov[fuelep,ec,poll,area] = maximum(PCCovTemp[fuelep,ec,poll,:,area])
    end

    for area in Areas,poll in Polls,fuelep in FuelEPs
      PCost[fuelep,ec,poll,area] = PCostECC[ecc,poll,area]*PCCov[fuelep,ec,poll,area]
    end
  ...
  #
  # Weighted Average of Device Capital Charge Rate using the first enduse.
  # - Jeff Amlin 02/11/23
  #
  enduse = 1
  for fuelep in FuelEPs,area in Areas,ec in ECs
    @finite_math DCCRP[fuelep,ec,area] = 
      sum(DCCRPrior[enduse,tech,ec,area]*
          DmdFEPTechPrior[fuelep,tech,ec,area] for tech in Techs)/
  ...
  #
  for fuelep in FuelEPs,ec in ECs,poll in Polls,area in Areas
    @finite_math VR[fuelep,ec,poll,area] = VRPrior[fuelep,ec,poll,area]+
      DT*(VRP[fuelep,ec,poll,area]-VRPrior[fuelep,ec,poll,area])/VRRT[ec]
  end
  ...
  for market in Markets
    ...
    if (!isempty(areas)) && (!isempty(ecs)) && (!isempty(polls))
      ...
      if (CapTrade[market] == 1) || (CapTrade[market] == 3)
        ...
        #
        for fuelep in FuelEPs,ec in ecs,poll in polls,area in areas
          @finite_math RCC[fuelep,ec,poll,area] = 
            (PCost[fuelep,ec,poll,area]*PCCOv[fuelep,ec,poll,area]*Inflation[area]+
            PCostExo[fuelep,ec,poll,area]*Inflation[area])/
            (DCCRP[fuelep,ec,area]+ROCF[fuelep,ec,poll,area])
        end

        for area in areas
          # nation = Select(ANMap[area,Nation], ==(1))
          nation = only(Select(ANMap[area, :], .==(1)))
          for ec in ecs, poll in polls, fuelep in FuelEPs
            ...
            if RPCSw[ec,poll,area] == 1
              @finite_math IRP[fuelep,ec,poll,area] =
                ln(RCC[fuelep,ec,poll,area]/Inflation[area]/
                (PCostN[fuelep,ec,poll,area]/PCostM[fuelep,ec,poll,area]/
                RCostM[fuelep,poll]))/
              PVF[fuelep,ec,poll,area]*PCCov[fuelep,ec,poll,area]
            ...
            elseif (RPCSw[ec,poll,area] == 2) &&
                   (PCost[fuelep,ec,poll,area] != 0 || 
                    PCostExo[fuelep,ec,poll,area] != 0) && 
                   (PCostN[fuelep,ec,poll,area] != 0) &&
                   (PVF[fuelep,ec,poll,area] != 0)
              @. CostMax = max(((PCost+PCostExo)*PCostM),0.01)
              @finite_math IRP[fuelep,ec,poll,area] = 1/(1+((CostMax[fuelep,ec,poll,area]*
                RCostM[fuelep,poll])/PCostN[fuelep,ec,poll,area])^
                PVF[fuelep,ec,poll,area])*PCCov[fuelep,ec,poll,area]
        ...
        #
        for fuelep in FuelEPs, ec in ecs, poll in polls, area in areas
          @finite_math RP[fuelep,ec,poll,area] = RPPrior[fuelep,ec,poll,area]+
            (max(RPPrior[fuelep,ec,poll,area],IRP[fuelep,ec,poll,area])-
            RPPrior[fuelep,ec,poll,area])/RCD[ec,poll]-
            RPPrior[fuelep,ec,poll,area]/RCPL[ec,poll]
        end
      ...
      elseif (CapTrade[market] == 2) || (CapTrade[market] == 4)
          ...
          for ec in ecs,poll in polls
            ...
            if RPCSw[ec,poll,area] == 1
              for fuelep in FuelEPs
                if RPFull[fuelep,ec,poll,area] > 0.0
                  @finite_math RCC[fuelep,ec,poll,area] = (PCostN[fuelep,ec,poll,area]/
                  RCostM[fuelep,poll])*exp(PVF[fuelep,ec,poll,area]*
                  RPFull[fuelep,ec,poll,area])*Inflation[area]
                else
                  RCC .= 0.0
                end
              end
            ...
            elseif RPCSw[ec,poll,area] == 2
              ...
              for fuelep in FuelEPs
                @finite_math RCC[fuelep,ec,poll,area] =
                  (1/RPFull[fuelep,ec,poll,area]-1)^(1/PVF[fuelep,ec,poll,area])*
                  PCostN[fuelep,ec,poll,area]/RCostM[fuelep,poll]/
                  (DCCRP[fuelep,ec,area]+ROCF[fuelep,ec,poll,area])*Inflation[area]
              end
            ...
            elseif RPCSw[ec,poll,area] == 3
              for fuelep in FuelEPs
                if RPFull[fuelep,ec,poll,area] > 0
                  @finite_math RCC[fuelep,ec,poll,area] =
                  (PCostN[fuelep,ec,poll,area]/RCostM[fuelep,poll])*
                  exp(PVF[fuelep,ec,poll,area]*RPFull[fuelep,ec,poll,area])*Inflation[area]
                else
                  RCC[fuelep,ec,poll,area] = 0
                end
              end
        ...
        #
        for fuelep in FuelEPs, ec in ecs, poll in polls, area in areas
          @finite_math IPCost[fuelep,ec,poll,area] = RCC[fuelep,ec,poll,area]*
            (DCCRP[fuelep,ec,area]+ROCF[fuelep,ec,poll,area])/Inflation[area]
        end       
        ...
        #
        for fuelep in FuelEPs, ec in ecs, poll in polls, area in areas
          @finite_math PCost[fuelep,ec,poll,area] =
            PCostPrior[fuelep,ec,poll,area]+(IPCost[fuelep,ec,poll,area]-
            PCostPrior[fuelep,ec,poll,area])/RCD[ec,poll]
        end
      ...
      elseif CapTrade[market] == 5
        for fuelep in FuelEPs, ec in ecs, poll in polls, area in areas
          RP[fuelep,ec,poll,area] = 0.0
          RCC[fuelep,ec,poll,area] = 0.0
          if PCCov[fuelep,ec,poll,area] == 0
            PCost[fuelep,ec,poll,area] = 0
          end
        end
  ...
  for ec in ECs,area in Areas,enduse in Enduses,tech in Techs
    @finite_math RPEI[enduse,tech,ec,area] = prod((1+
      sum(RP[fuelep,ec,poll,area]*DmdFEPTechPrior[fuelep,tech,ec,area] for fuelep in FuelEPs)/
                              sum(DmdFEPTechPrior[fuelep,tech,ec,area] for fuelep in FuelEPs)* 
...
function TPrice(data::Data)
  ...
  (; ECESMap,ECFP,ECFPFuel,EuDemPrior,ExpCP,FEPCP,FPCFS) = data
  ...
  #
  for fuelep in FuelEPs,ec in ECs,poll in Polls,area in Areas
    @finite_math PolMarginal[fuelep,ec,poll,area] = 
      sum((POCX[enduse,fuelep,ec,poll,area]*(1-ZeroFr[fuelep,poll,area])*
           RM[fuelep,ec,poll,area]*max(EuDemPrior[enduse,fuelep,ec,area],1e-12))
...
function CMarginal(data::Data)
  ...
  for enduse in Enduses,tech in Techs,ec in ECs,area in Areas
    ...
    if PCCRB[enduse,tech,ec,area] > 0  &&
       ...
       PEPM[enduse,tech,ec,area]  > 0  &&
       PFPN[enduse,tech,ec,area]  > 0    
      PEEPoll[enduse,tech,ec,area] = PEM[enduse,ec,area]*
      ...
      PEEPoll[enduse,tech,ec,area] = 
        PEM[enduse,ec,area]*PEMM[enduse,tech,ec,area]*PEMMM[enduse,tech,ec,area]
    end
    
    #
    # Process Efficiency using Long Term Price Elasticity
    #
    @finite_math PEEElas[enduse,tech,ec,area] = PEM[enduse,ec,area]*
  ...
  for enduse in Enduses,tech in Techs,ec in ECs,area in Areas
    if PEESw[enduse,tech,ec,area] == 1
      ...
      PEEPrice[enduse,tech,ec,area] = min(max(PEEPrice[enduse,tech,ec,area],
        ...
        PEM[enduse,ec,area]*PEMM[enduse,tech,ec,area]*0.98)
    ...
    elseif PEESw[enduse,tech,ec,area] == 3
      ...
      PEEPoll[enduse,tech,ec,area] = min(max(PEEPoll[enduse,tech,ec,area],
        PEStd[enduse,tech,ec,area],PEStdP[enduse,tech,ec,area],
        PEEPrior[enduse,tech,ec,area]*PEEFloorSw[ec,area]),
        PEM[enduse,ec,area]*PEMM[enduse,tech,ec,area]*PEMMM[enduse,tech,ec,area]*0.98)
        ...
        for tech in Techs       
          ...
          if (Enduse[enduse] == "Heat")      || (Enduse[enduse] == "Ground")  ||
            ...
            @finite_math APCC[enduse,tech,ec,area] = PCCN[enduse,tech,ec,area]*PCCMM[enduse,tech,ec,area]*
              PCMMM[enduse,tech,ec,area]*Inflation[area]*(PEM[enduse,ec,area]*
              PEMM[enduse,tech,ec,area]*PEMMM[enduse,tech,ec,area]/
          ...
          #
          @finite_math RPEE[enduse,tech,ec,area] = PEM[enduse,ec,area]*RPEMM[enduse,tech,ec,area]*
...
function CogenerationTotals(data::Data)
  ...
  for ec in ECs,area in Areas,tech in Techs
    ecc = Select(ECC,EC[ec])
    CgDmd[tech,ec,area] = sum(CgDemand[fuel,ecc,area]*FTMap[fuel,tech] for fuel in Fuels)
    CgEG[tech,ec,area] = sum(CgGen[fuel,ecc,area]*FTMap[fuel,tech] for fuel in Fuels)
    CgGC[tech,ec,area] = sum(CgCap[fuel,ecc,area]*FTMap[fuel,tech] for fuel in Fuels)
...
function FeedstockDemand(data::Data)
  ...
  #
  for area in Areas,ec in ECs,fuel in Fuels
    FsDem[fuel,ec,area] = sum(FsDmd[tech,ec,area]*FsFrac[fuel,tech,ec,area] for tech in Techs)
  end

  for area in Areas,ec in ECs,fuel in Fuels
    ecc = Select(ECC,EC[ec])
    FsDemand[fuel,ecc,area] = FsDem[fuel,ec,area]
  end
...
function PollCoefficients(data::Data)
  ...
  (; POEM,StockAdjustment,RM,DER,BCMult,FFPMap) = data
  ...
  for tech in Techs,ec in ECs,area in Areas,poll in Polls,enduse in Enduses,fuelep in FuelEPs
    if PolSw[tech,ec,poll,area] == 1
      ...
      #
      POEMA[enduse,fuelep,ec,poll,area] = DERA[enduse,tech,ec,area]*
        POCX[enduse,fuelep,ec,poll,area]/1e6
      
      #
      # Embedded pollution for retired devices (POEMR)
      #
      @finite_math POEMR[enduse,fuelep,ec,poll,area] = DERR[enduse,tech,ec,area]*
        POCAPrior[enduse,fuelep,ec,poll,area]/RMPrior[fuelep,ec,poll,area]/1e6
      
      #
      # Total embedded pollution
      #
      POEM[enduse,fuelep,ec,poll,area] = POEMPrior[enduse,fuelep,ec,poll,area]+
        DT*(POEMA[enduse,fuelep,ec,poll,area]-POEMR[enduse,fuelep,ec,poll,area])
        
      POEM[enduse,fuelep,ec,poll,area] = POEM[enduse,fuelep,ec,poll,area]*
        (1+StockAdjustment[enduse,tech,ec,area])
      
      #
      # Average Pollution Coefficient
      #
      @finite_math POCA[enduse,fuelep,ec,poll,area] = POEM[enduse,fuelep,ec,poll,area]/
        DER[enduse,tech,ec,area]*1E6*RM[fuelep,ec,poll,area]
    ...
    elseif PolSw[tech,ec,poll,area] == 2
      ...
      #
      POCA[enduse,fuelep,ec,poll,area] = POCX[enduse,fuelep,ec,poll,area]*
        RM[fuelep,ec,poll,area]
        
      @finite_math POEM[enduse,fuelep,ec,poll,area] = POCA[enduse,fuelep,ec,poll,area]*
        DER[enduse,tech,ec,area]/1e6/RM[fuelep,ec,poll,area]
    ...
    elseif PolSw[tech,ec,poll,area] == 3
      ...
      #
      @finite_math POEMR[enduse,fuelep,ec,poll,area] = DERR[enduse,tech,ec,area]*
        POCA[enduse,fuelep,ec,poll,area]/RMPrior[fuelep,ec,poll,area]/1e6
  ...
  #
  for fuel in Fuels,ec in ECs,poll in Polls,area in Areas
    FsPOCA[fuel,ec,poll,area] = min(FsPOCX[fuel,ec,poll,area],FsPOCS[fuel,ec,poll,area])
  end
      ...
      if EC[ec] == ECC[ecc]
        for fuelep in FuelEPs, fuel in Fuels
          if FFPMap[fuelep,fuel] == 1.0
            for area in Areas
              for eu in Enduses
                POCX[eu,fuelep,ec,bc,area] = POCX[eu,fuelep,ec,pm25,area]*BCMult[fuel,ecc,area]
                POCA[eu,fuelep,ec,bc,area] = POCA[eu,fuelep,ec,pm25,area]*BCMult[fuel,ecc,area]
              end
              FsPOCX[fuel,ec,bc,area] = FsPOCX[fuel,ec,pm25,area]   *BCMult[fuel,ecc,area]
              FsPOCA[fuel,ec,bc,area] = FsPOCA[fuel,ec,pm25,area]   *BCMult[fuel,ecc,area]
              RM[fuelep,ec,bc,area] = RM[fuelep,ec,pm25,area]
            end
          end
        end
      end
...
function SequesteringPotential(data::Data)
  (; db,year) = data
  (; Areas,EC,ECs,Enduses,ECC,ECCs,Fuels,Poll,Polls,FuelEPs) = data
  (; EnSqPot,Polute,SqEnMap,FsSqPot,FsPol,CgSqPot,CgFPolGross) = data
  (; MESqPot,MEPol,SqPolCCPenalty,SqPotential,SqPenaltyFrac) = data

  for ec in ECs,poll in Polls,area in Areas
    ecc = Select(ECC,EC[ec])
    EnSqPot[ecc,poll,area] = sum(Polute[enduse,fuelep,ec,poll,area]*
      SqEnMap[enduse] for enduse in Enduses,fuelep in FuelEPs)
    FsSqPot[ecc,poll,area] = sum(FsPol[fuel,ec,poll,area] for fuel in Fuels)
...
function PRAccounting(data::Data)
  (; db,year) = data
  (; Areas,EC,ECs,Enduses,ECC,FuelEPs,Polls) = data
  ...
  for fuelep in FuelEPs,ec in ECs,poll in Polls,area in Areas
    @finite_math RICap[fuelep,ec,poll,area] = sum(Polute[enduse,fuelep,ec,poll,area] for enduse in Enduses) +
      CgPolEC[fuelep,ec,poll,area]/RM[fuelep,ec,poll,area]*RPFull[fuelep,ec,poll,area]
  end
  ...
  #
  for fuelep in FuelEPs,ec in ECs,poll in Polls,area in Areas
    @finite_math RCI[fuelep,ec,poll,area] = max(RICap[fuelep,ec,poll,area]-
      RCapPrior[fuelep,ec,poll,area]-RCRPrior[fuelep,ec,poll,area]*RCD[ec,poll]+
      RCapPrior[fuelep,ec,poll,area]/RCPL[ec,poll],0.0)/RCD[ec,poll]
  end
  ...
  #
  for fuelep in FuelEPs,ec in ECs,poll in Polls,area in Areas
    @finite_math RCap[fuelep,ec,poll,area] = RCapPrior[fuelep,ec,poll,area]+DT*
      (RCRPrior[fuelep,ec,poll,area]-RCapPrior[fuelep,ec,poll,area]/RCPL[ec,poll])
  end
  ...
  #
  for fuelep in FuelEPs,ec in ECs,poll in Polls,area in Areas
    @finite_math RCR[fuelep,ec,poll,area] = RCRPrior[fuelep,ec,poll,area]+DT*
      (RCI[fuelep,ec,poll,area]-RCRPrior[fuelep,ec,poll,area])/RCD[ec,poll]
  end
  ...
  for area in Areas,ec in ECs,poll in Polls
    ...
    #
    PRExp[ecc,poll,area] = sum(RCR[fuelep,ec,poll,area]*RCC[fuelep,ec,poll,area]*(1-AGFr[ecc,poll,area])+
      RCCEm[fuelep,ec,poll,area]*ROCF[fuelep,ec,poll,area] for fuelep in FuelEPs)/1e6
    #
    # Government Expenses for Pollution Reductions
    #
    GRExp[ecc,poll,area] = sum(RCR[fuelep,ec,poll,area]*RCC[fuelep,ec,poll,area]*
      (AGFr[ecc,poll,area]) for fuelep in FuelEPs)/1e6+PAdCost[ecc,poll,area]
  end
...
function PollutionGenerated(data::Data)
  (; db,year) = data
  (; Areas,EC,ECs,ECC,ECCs,Polls,Enduse,Enduses,Fuels,FuelEPs,PCov,Sector) = data
  (; CgFPol,CgPol,CgPolEC,CgPolSq,CgPolSqPenalty,ECoverage) = data
  (; EuDem,EuFPol,EuPol,FFPMap,FsDem,FsPOCA,FsPol,GrossEnFPol,GrossPol) = data
  (; NcFPol,NcPol,OREnFPol,PCCov,POCA,Polute,RM,SqPolCg) = data
  (; SqPolCgPenalty,TFPol,TotFPol,TSPol,xPolute,ZeroFr) = data
  ...
  for area in Areas,poll in Polls,ec in ECs,fuel in Fuels
    FsPol[fuel,ec,poll,area] = FsDem[fuel,ec,area]*FsPOCA[fuel,ec,poll,area]
  end
  ...
  for area in Areas,poll in Polls,ec in ECs,fuelep in FuelEPs
    ecc = Select(ECC,EC[ec])
    EuFPol[fuelep,ecc,poll,area] = sum(Polute[enduse,fuelep,ec,poll,area]*
      (1-ZeroFr[fuelep,poll,area]) for enduse in Enduses)
  end
  ...
  if SectorName == "Industrial"
    ...
    for ec in ECs
      ...
      for fuelep in FuelEPs
        for area in Areas, poll in Polls
          OREnFPol[fuelep,ecc,poll,area]=Polute[enduse,fuelep,ec,poll,area]
        end
      end
    end
  ...
  for area in Areas,poll in Polls,ec in ECs,fuel in Fuels
    ecc = Select(ECC,EC[ec])
    NcFPol[fuel,ecc,poll,area] = FsPol[fuel,ec,poll,area]
  end
  ...
  for ec in ECs
    ...
    for area in Areas, poll in Polls
      ...
      for fuelep in FuelEPs
        if RM[fuelep,ec,poll,area] != 0
          GrossEnFPol[fuelep,ec,poll,area] =
            (EuFPol[fuelep,ecc,poll,area]+CgFPol[fuelep,ecc,poll,area])/
            RM[fuelep,ec,poll,area]*PCCov[fuelep,ec,poll,area]
        else
          GrossEnFPol[fuelep,ec,poll,area] = 0.0
        end
      end
      
      GrossPol[ecc,poll,area] = 
        sum(GrossEnFPol[fuelep,ec,poll,area] for fuelep in FuelEPs)+
...
function Investments(data::Data)
  ...
  for ec in ECs
    ...
    if SectorName != "Transportation"
      ...
      #
      for area in Areas
        RInv[ecc,area] = sum(RCR[fuelep,ec,poll,area] *RCC[fuelep,ec,poll,area]*
          (1-AGFr[ec,poll,area]) for poll in Polls,fuelep in FuelEPs)/ 1000000
        # 
        # Emission Reduction O&M Costs
        #
        ROMExp[ecc,area] = sum(RCCEm[fuelep,ec,poll,area]*
          ROCF[fuelep,ec,poll,area] for poll in Polls, fuelep in FuelEPs)/1e6
      end
    end
  end
