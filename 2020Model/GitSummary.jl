...
Usage:
  julia bin/GitSummary.jl [new_commit] [old_commit]
...
Examples:
  ...
  julia bin/GitSummary.jl               # compare HEAD against most recent merge commit
  julia bin/GitSummary.jl abc123        # compare abc123 against most recent merge commit
  julia bin/GitSummary.jl abc123 2      # compare abc123 against second most recent merge commit
  julia bin/GitSummary.jl abc123 def456 # compare abc123 against def456
"""
