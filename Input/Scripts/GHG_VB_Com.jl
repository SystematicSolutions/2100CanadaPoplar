#
# GHG_VB_Com.jl - Read in Commercial GHG emissions coefficients from VBInput
#
using EnergyModel
...
function CommCalibration(db)
  ...
  println("Reading Commercial GHG POCX")  
  ...
  CommECCs = Select(ECC, (from = "Wholesale", to = "StreetLighting"))
  ...
  println("Reading Commercial GHG CgPOCX")  
  ...
  println("Reading Commercial GHG FsPOCX")  
...
function CalibrationControl(db)
  @info "GHG_VB_Com.jl - CalibrationControl"
