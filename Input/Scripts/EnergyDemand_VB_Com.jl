#
# EnergyDemand_VB_Com.jl - Map commercial energy demands from VBInput
#
using EnergyModel

module EnergyDemand_VB_Com
...
function CCalibration(db)
  data = CControl(; db)
  (;Input,Areas,ECCs,ECs,Enduses,Fuels,Techs,Years,vEnduses,ECCMap) = data
...
function CalibrationControl(db)
  @info "EnergyDemand_VB_Com.jl - CalibrationControl"
