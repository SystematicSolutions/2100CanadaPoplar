#
# DmFrac_Calc_Trans.jl - Calculate xDmFrac from vDmd and vFsDmd
#
using EnergyModel

module DmFrac_Calc_Trans
...
function DmFrac_Calc(db)
  data = TControl(; db)
  (;Input,Areas,ECs,Enduses) = data
  (;Fuels,Techs,Years) = data
...
function Control(db)
  @info "DmFrac_Calc_Trans.jl - Control"
