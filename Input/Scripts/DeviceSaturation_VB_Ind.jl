#
# DeviceSaturation_VB_Ind.jl - Map industrial device saturation from VBInput
#
using EnergyModel

module DeviceSaturation_VB_Ind
...
function CalibrationControl(db)
  @info "DeviceSaturation_VB_Ind.jl - CalibrationControl"
