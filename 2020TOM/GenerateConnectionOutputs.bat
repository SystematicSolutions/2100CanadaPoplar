rem
rem  GenerateConnectionOutputs.bat
rem
rem  %1 - Scenario Name plus Iteration
rem  %2 - Base Case 
rem  %3 - Reference Case
rem  %4 - Scenario for zInitial in Access outputs
rem  %5 - Economic Model Investments Case (see Jeff)
rem  %6 - Variant 
rem
    Call SetScenarioName %1%6 %2 %3 %4 %4 %5
rem
rem  Unzip E2020 databases inside \2020Model
rem  
     cd ..\2020Model\     
rem
     cd ..\2020TOM\
rem
     ...
     Call PrmFile ChemicalsReport.txo
     Call PrmFile EnergyIntensityReport.txo
...
rem     Call PrmFile DeviceInvestmentsReport.txo
...
rem
     Call SetScenarioName %1 %2 %3 %4 %4 %5