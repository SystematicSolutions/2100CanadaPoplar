...
Base.@kwdef struct CogenerationSummary_IndData
  db::String
...
function CogenerationSummary_Ind_DtaRun(data,areas,eccs,AreaName,AreaKey)
  ...
  println(iob,"This file was produced by CogenerationSummary_Ind.txo")
  println(iob)
  println(iob)
  ...
  #
  filename = "CogenerationSummary_Ind-$(AreaKey)-$SceName.dta"
  open(joinpath(OutputFolder,filename),"w") do filename
    write(filename,String(take!(iob)))
  end
end

function CogenerationSummary_Ind_DtaControl(db)
  @info "CogenerationSummary_Ind_DtaControl"
  data = CogenerationSummary_IndData(; db)
  ...
  AreaName = "Canada"
  AreaKey = "CN"
  CogenerationSummary_Ind_DtaRun(data,areas,eccs,AreaName,AreaKey)
  #
  # US
  #
  ...
  for area in areas
    ...
    AreaKey = Area[area]
    CogenerationSummary_Ind_DtaRun(data,area,eccs,AreaName,AreaKey)
  end

end

if abspath(PROGRAM_FILE) == @__FILE__
CogenerationSummary_Ind_DtaControl(DB)
end
