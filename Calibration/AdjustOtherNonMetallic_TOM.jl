#
# AdjustOtherNonMetallic_TOM.jl
#
using EnergyModel

module AdjustOtherNonMetallic_TOM
...
function ICalibration(db)
  ...
  if MacroSwitch[Select(Nation,"CN")] == "TOM"
    ...
    #
    # Prince Edward Island use Ontario
    # 
    ec = Select(EC,"OtherNonMetallic")
...
function CalibrationControl(db)
  @info "AdjustOtherNonMetallic_TOM.jl - CalibrationControl"
