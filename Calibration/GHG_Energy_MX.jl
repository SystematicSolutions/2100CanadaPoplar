#
# GHG_Energy_MX.jl - Reads in U.S. GHG emission factors
#
using EnergyModel

module GHG_Energy_MX
...
function process_emissions!(data::RControl, records::Vector{EmissionsRecord})
  MX = Select(data.Nation, "MX")
  areas = findall(a -> data.ANMap[a, MX] == 1, data.Areas)
