...
function ElecPolicy(db)
  ...
  #
  for year in years, area in areas, ecc in eccs
    OBAFraction[ecc,area,year] = 1.00
  end
  ...
  ecc = Select(ECC,"OtherNonMetallic")
  for year in years, area in areas
  ...
  for fuelep in FuelEPs, plant in plants
    ...
    OBAElectric[plant,fuelep,Yr(2022)] = 785.0
  end
  years = collect(Yr(2023):YrFinal)
  for year in years, fuelep in FuelEPs, plant in plants
    OBAElectric[plant,fuelep,year] = 668
  end
  
  fueleps = Select(FuelEP,"NaturalGas")
  years = collect(Yr(2019):Yr(2022))
  for year in years, fuelep in fueleps, plant in plants
    OBAElectric[plant,fuelep,year] = 420.0
  end
  years = collect(Yr(2023):Yr(2025))
  for year in years, fuelep in fueleps, plant in plants
    OBAElectric[plant,fuelep,year] = 395.0
  end
  years = Yr(2026)
  for year in years, fuelep in fueleps, plant in plants
    OBAElectric[plant,fuelep,year] = 390
  end
  years = collect(Yr(2027):Yr(2029))
  for year in years, fuelep in fueleps, plant in plants
    OBAElectric[plant,fuelep,year] = 370
  end
  years = collect(Yr(2030):Final)
  for year in years, fuelep in fueleps, plant in plants
    OBAElectric[plant,fuelep,year] = 240
  end
  years = collect(Current:YrFinal)
  ...
  for fuelep in FuelEPs, plant in plants
    ...
    OBAElectric[plant,fuelep,Yr(2022)] = 793.0
