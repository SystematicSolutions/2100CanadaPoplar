...
function ElecPolicy(db)
  ...
  eccs = Select(ECC,"IronSteel")
  years = collect(Yr(2019):Yr(2022))
  for year in years, area in areas, ecc in eccs
    OBAFraction[ecc,area,year] = 1.0
  end
  for area in areas, ecc in eccs
    OBAFraction[ecc,area,Yr(2020)] = 0.88
    OBAFraction[ecc,area,Yr(2021)] = 0.77
    OBAFraction[ecc,area,Yr(2022)] = 0.66
    OBAFraction[ecc,area,Yr(2023)] = 0.66
    OBAFraction[ecc,area,Yr(2024)] = 0.66
    OBAFraction[ecc,area,Yr(2025)] = 0.58
    OBAFraction[ecc,area,Yr(2026)] = 0.57
    OBAFraction[ecc,area,Yr(2027)] = 0.57
    OBAFraction[ecc,area,Yr(2028)] = 0.57
    OBAFraction[ecc,area,Yr(2029)] = 0.57
    OBAFraction[ecc,area,Yr(2030)] = 0.25
    OBAFraction[ecc,area,Yr(2031)] = 0.25
    OBAFraction[ecc,area,Yr(2032)] = 0.25
    OBAFraction[ecc,area,Yr(2033)] = 0.25
    OBAFraction[ecc,area,Yr(2034)] = 0.25
  end
  years = collect(Yr(2035):Final)
  for year in years, area in areas, ecc in eccs
    OBAFraction[ecc,area,year] = 0.25
  end 
