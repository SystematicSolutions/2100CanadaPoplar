...
function CreateUnits(db)
  ...
  UnCode[uncounter] = "MX_OGCT"
  UnName[uncounter] = "MX_OGCT"
  CommonCharacteristics(data,uncounter,OGCT,genco,node,area,MX)
  ...
  node  = Select(Node,Area[area])
  uncounter = uncounter+1
  UnCode[uncounter]="MX_OGCC"
  UnName[uncounter]="MX_OGCC"
  CommonCharacteristics(data,uncounter,OGCC,genco,node,area,MX)
  ...
  node  = Select(Node,Area[area])
  uncounter = uncounter+1
  UnCode[uncounter]="MX_OGSteam"
  UnName[uncounter]="MX_OGSteam"
  CommonCharacteristics(data,uncounter,OGSteam,genco,node,area,MX)
  ...
  node  = Select(Node,Area[area])
  uncounter = uncounter+1
  UnCode[uncounter]="MX_Coal"
  UnName[uncounter]="MX_Coal"
  CommonCharacteristics(data,uncounter,Coal,genco,node,area,MX)
  ...
  node  = Select(Node,Area[area])
  uncounter = uncounter+1
  UnCode[uncounter]="MX_Nuclear"
  UnName[uncounter]="MX_Nuclear"
  CommonCharacteristics(data,uncounter,Nuclear,genco,node,area,MX)
  ...
  node  = Select(Node,Area[area])
  uncounter = uncounter+1
  UnCode[uncounter]="MX_PeakHydro"
  UnName[uncounter]="MX_PeakHydro"
  CommonCharacteristics(data,uncounter,PeakHydro,genco,node,area,MX)
  ...
  node  = Select(Node,Area[area])
  uncounter = uncounter+1
  UnCode[uncounter]="MX_Biomass"
  UnName[uncounter]="MX_Biomass"
  CommonCharacteristics(data,uncounter,Biomass,genco,node,area,MX)
  ...
  node  = Select(Node,Area[area])
  uncounter = uncounter+1
  UnCode[uncounter]="MX_OnshoreWind"
  UnName[uncounter]="MX_OnshoreWind"
  CommonCharacteristics(data,uncounter,OnshoreWind,genco,node,area,MX)
  ...
  node  = Select(Node,Area[area])
  uncounter = uncounter+1
  UnCode[uncounter]="MX_Geothermal"
  UnName[uncounter]="MX_Geothermal"
  CommonCharacteristics(data,uncounter,Geothermal,genco,node,area,MX)
  ...
  node  = Select(Node,Area[area])
  uncounter = uncounter+1
  UnCode[uncounter]="MX_SolarPV"
  UnName[uncounter]="MX_SolarPV"
  CommonCharacteristics(data,uncounter,SolarPV,genco,node,area,MX)
