#
# AdjustOtherManufacturing_TOM.jl
#
using EnergyModel

module AdjustOtherManufacturing_TOM
...
function ICalibration(db)
  ...
  if MacroSwitch[CN] == "TOM"
    ...
    SetPCTC(data,ON,NU,OtherManufacturing)
    
  end
end

function CalibrationControl(db)
  @info "AdjustOtherManufacturing_TOM.jl - CalibrationControl"
