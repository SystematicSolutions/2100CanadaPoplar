#
# ComScrappageRates.jl
#
using EnergyModel

module ComScrappageRates
...
function CCalibration(db)
  ...
  Lambda[Heat,Geothermal]=27.0 # GEO_HP
  Lambda[Heat,DualHPump]=25.8 # NG_HP

  #
  # Lambda AC
  # 
  # Lambda[AC,Electric]=10.40 #ROOM_AIR
  Lambda[AC,Electric]=19.4#CENT_AIR
  Lambda[AC,HeatPump]=27.0 #ELEC_HP
  Lambda[AC,Geothermal]=27.0 #GEO_HP
  Lambda[AC,DualHPump]=25.8 #NG_HP
  
  #
  # Lambda Water Heating
  # 
  Lambda[HW,Gas]=8.7 #NG_WH
  Lambda[HW,Electric]=8.7 #ELEC_WH
  Lambda[HW,Oil]=8.7 #DIST_WH
  Lambda[HW,LPG]=8.7 #LPG_WH
  Lambda[HW,Solar]=8.6 #SOLAR_WH
  ...
  Lambda[OthSub,Gas]=10.4 #NG_STV
  Lambda[OthSub,LPG]=10.4 #LPG_STV
  Lambda[OthSub,Electric]=10.6 #ELEC_STV
  ...
  # Lambda Refrig
  #
  Lambda[Refrig,Electric]=15.9 #REFR
...
function CalibrationControl(db)
  @info "ComScrappageRates.jl - CalibrationControl"
