#
# AdjustOtherMetalMining_TOM.jl
#
using EnergyModel

module AdjustOtherMetalMining_TOM
...
Base.@kwdef struct IControl
  ...
  PCTC::VariableArray{5} = ReadDisk(db,"$Outpt/PCTC") # [Enduse,Tech,EC,Area,Yea [Enduse,EC,Area]r] Process Capital Cap. Trade Off Coef. (DLESS)
...
function ICalibration(db)
  ...
  if MacroSwitch[Select(Nation,"CN")] == "TOM"
    #
    #  Northwest Territories use Ontario
    # 
...
function CalibrationControl(db)
  @info "AdjustOtherMetalMining_TOM.jl - CalibrationControl"
