#
# Res_HistoricalProcessEfficiency.jl
#
using EnergyModel

module Res_HistoricalProcessEfficiency
...
function RCalibration(db)
  ...
  (;EnduseDS,Enduses,Nation,NationDS,Nations,Tech,TechDS,Techs,Year,YearDS) = data
  (;Years, Input) = data
  (;DDay,DDayNorm,DDCoefficient,DEE,DEM,DEStd,DEStdP,DFPN,DFTC,DSt) = data
  (;DPL,ECFP,ECUF,Inflation,PDif,PER,TSLoad,xDEE,xDEEA,xDmd) = data
...
function CalibrationControl(db)
  @info "Res_HistoricalProcessEfficiency.jl - CalibrationControl"
